...
public:
        ...
        lua_State* L) override
    {
        ...
        lua_pushinteger(L, EMILUA_CONFIG_IPC_ACTOR_MESSAGE_MAX_MEMBERS_NUMBER);
...
private:
    ...
    generate_good_message(ipc_actor_message& message, int descriptors[]);
...
std::uniform_int_distribution<std::uint8_t>
ipc_actor_badinjector_plugin::bool_dist;
...
std::uniform_int_distribution<std::uint8_t>
ipc_actor_badinjector_plugin::str_size_dist;

std::uniform_int_distribution<std::uint8_t>
ipc_actor_badinjector_plugin::dict_size_dist;
...
int ipc_actor_badinjector_plugin::to_base64(lua_State* L)
{
...
int ipc_actor_badinjector_plugin::padding_exists(lua_State* L)
{
...
int ipc_actor_badinjector_plugin::send_too_small(lua_State* L)
{
...
int ipc_actor_badinjector_plugin::send_too_big(lua_State* L)
{
    auto channel = static_cast<ipc_actor_address*>(lua_touserdata(L, 1));
    auto channelfd = channel->dest.native_handle();
    ipc_actor_message messages[2];
...
int ipc_actor_badinjector_plugin::send_too_many_fds(lua_State* L)
{
    auto channel = static_cast<ipc_actor_address*>(lua_touserdata(L, 1));
    auto channelfd = channel->dest.native_handle();
    ipc_actor_message message;
    ...
    message.members[0].as_int = EXPONENT_MASK | ipc_actor_message::nil;
...
int ipc_actor_badinjector_plugin::send_invalid_root(lua_State* L)
{
    auto channel = static_cast<ipc_actor_address*>(lua_touserdata(L, 1));
    auto channelfd = channel->dest.native_handle();
    ipc_actor_message message;
...
int ipc_actor_badinjector_plugin::send_overflow_root_str(lua_State* L)
{
    auto channel = static_cast<ipc_actor_address*>(lua_touserdata(L, 1));
    auto channelfd = channel->dest.native_handle();
    ipc_actor_message message;
    ...
    message.members[0].as_int = EXPONENT_MASK | ipc_actor_message::nil;
    message.members[1].as_int = EXPONENT_MASK | ipc_actor_message::string;
...
int ipc_actor_badinjector_plugin::send_overflow_empty_key_str(lua_State* L)
{
    auto channel = static_cast<ipc_actor_address*>(lua_touserdata(L, 1));
    auto channelfd = channel->dest.native_handle();
    ipc_actor_message message;
    ...
    message.members[1].as_int = EXPONENT_MASK | ipc_actor_message::nil;
...
int ipc_actor_badinjector_plugin::send_missing_root_fd(lua_State* L)
{
    auto channel = static_cast<ipc_actor_address*>(lua_touserdata(L, 1));
    auto channelfd = channel->dest.native_handle();
    ipc_actor_message message;
    ...
    message.members[1].as_int =
        EXPONENT_MASK | ipc_actor_message::file_descriptor;
...
int ipc_actor_badinjector_plugin::send_missing_root_actorfd(lua_State* L)
{
    auto channel = static_cast<ipc_actor_address*>(lua_touserdata(L, 1));
    auto channelfd = channel->dest.native_handle();
    ipc_actor_message message;
    ...
    message.members[0].as_int = EXPONENT_MASK | ipc_actor_message::nil;
    message.members[1].as_int =
        EXPONENT_MASK | ipc_actor_message::actor_address;
...
int ipc_actor_badinjector_plugin::send_overflow_dict(lua_State* L)
{
    auto channel = static_cast<ipc_actor_address*>(lua_touserdata(L, 1));
    auto channelfd = channel->dest.native_handle();
    ipc_actor_message message;
...
int ipc_actor_badinjector_plugin::send_overflow_dict2(lua_State* L)
{
    auto channel = static_cast<ipc_actor_address*>(lua_touserdata(L, 1));
    auto channelfd = channel->dest.native_handle();
    ipc_actor_message message;
...
int ipc_actor_badinjector_plugin::send_invalid_leaf(lua_State* L)
{
    auto channel = static_cast<ipc_actor_address*>(lua_touserdata(L, 1));
    auto channelfd = channel->dest.native_handle();
    ipc_actor_message message;
    ...
    message.members[0].as_double = 0;
    message.members[1].as_int = EXPONENT_MASK | (MANTISSA_MASK ^ QNAN_BIT);
    message.members[2].as_int = EXPONENT_MASK | ipc_actor_message::nil;
...
std::string ipc_actor_badinjector_plugin::generate_good_string()
{
    std::string ret;
...
ipc_actor_badinjector_plugin::leaf_t
ipc_actor_badinjector_plugin::generate_good_leaf()
{
...
std::map<
    std::string,
    ipc_actor_badinjector_plugin::leaf_t
> ipc_actor_badinjector_plugin::generate_good_dict()
{
...
int ipc_actor_badinjector_plugin::fuzzer_seed(lua_State* L)
{
...
ipc_actor_badinjector_plugin::generate_good_message(
    ipc_actor_message& message, int descriptors[])
{
    ...
    if (bool_dist(prng) == 1) {
        ...
        std::visit(hana::overload(
            ...
            [&](std::string& s) {
                message.members[1].as_int =
                    EXPONENT_MASK | ipc_actor_message::string;
        ...
        if (i != CONFIG_MESSAGE_MAX_MEMBERS_NUMBER) {
            message.members[i].as_int = EXPONENT_MASK | ipc_actor_message::nil;
        }
    }
...
int ipc_actor_badinjector_plugin::fuzzer_send_good(lua_State* L)
{
    ipc_actor_message message;
    std::size_t message_size;
...
int ipc_actor_badinjector_plugin::fuzzer_send_bad(lua_State* L)
{
    ipc_actor_message message;
    std::size_t message_size;
    int descriptors[CONFIG_MESSAGE_MAX_MEMBERS_NUMBER];
...
emilua::ipc_actor_badinjector_plugin EMILUA_PLUGIN_SYMBOL;
emilua::ipc_actor_badinjector_plugin EMILUA_PLUGIN_SYMBOL;

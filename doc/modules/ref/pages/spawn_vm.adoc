...
`concurrency_hint: integer|"safe" = 0`::
...
`"safe"`::: Same as
https://www.boost.org/doc/libs/1_88_0/doc/html/boost_asio/overview/core/configuration.html#boost_asio.overview.core.configuration.configuration_from_concurrency_hint[`ASIO_CONCURRENCY_HINT_SAFE`].

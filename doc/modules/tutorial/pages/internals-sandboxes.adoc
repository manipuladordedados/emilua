[id=_tutorial_internals_sandboxes]
= Internals (sandboxes)
...
The purpose of this manual is to help you attack the system. If you're trying to
find security holes, this section should be a good overview on how the whole
system works.
...
fiber exists at the time (this can happen if the user canceled the fiber, or

...
EMILUA_API extern char ip_key;
EMILUA_API extern char ip_address_mt_key;
EMILUA_API extern char ip_tcp_socket_mt_key;
EMILUA_API extern char ip_tcp_acceptor_mt_key;
EMILUA_API extern char ip_udp_socket_mt_key;
